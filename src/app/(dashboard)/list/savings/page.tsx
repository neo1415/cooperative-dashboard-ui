...
// Inside useEffect to fetch transactions in frontend component
useEffect(() => {
    ...
    if (user) {
      try {
        ...
        const response = await axios.get(`${serverURL}/transactions`, {
          ...
          params: role === 'cooperative-admin' && cooperativeId ? { cooperativeId } : {},
        });
  ...
  return (
    <div>
      <h1 className="text-xl font-semibold">Members Savings and Withdrawals</h1>
...
export default MemberTransactionsTable;
