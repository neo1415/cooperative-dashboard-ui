...
const LoanApprovedPage = () => {
  const renderRow = (item: LoansRequested) => (
    ...
    >
      ...
      <td className="hidden md:table-cell">{item.interest}</td>
      <td className="hidden md:table-cell">{item.paid}</td>
      <td className="hidden md:table-cell">{item.address}</td>
      <td>
        <div className="flex items-center gap-2">
          <Link href={`/list/loansApproved/${item.id}`}>
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      ...
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">Approved Loans</h1>
