...
CREATE TABLE "CooperativeDetails" (
    ...
    "totalLoansRequested" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "totalLoansApproved" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "totalMembers" TEXT NOT NULL DEFAULT '',
    "totalDebtors" TEXT NOT NULL DEFAULT '',
